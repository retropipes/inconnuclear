...
public class DebufferSpellBook extends SpellBook {
	...
	final var spell0 = new Spell(spell0Effect, 1, BattleTarget.ENEMY, Sounds.DAMAGE_BOLT);
	...
	final var spell1 = new Spell(spell1Effect, 2, BattleTarget.ENEMY, Sounds.EFFECT_CONFUSED);
	...
	final var spell2 = new Spell(spell2Effect, 3, BattleTarget.ENEMY, Sounds.EFFECT_DUMBFOUNDED);
	...
	final var spell3 = new Spell(spell3Effect, 5, BattleTarget.ENEMY, Sounds.DAMAGE_BUBBLE);
	...
	final var spell4 = new Spell(spell4Effect, 7, BattleTarget.ENEMY, Sounds.EFFECT_DEBUFF);
	...
	final var spell5 = new Spell(spell5Effect, 11, BattleTarget.ENEMY, Sounds.EFFECT_DEBUFF);
	...
	final var spell6 = new Spell(spell6Effect, 13, BattleTarget.ENEMY, Sounds.EFFECT_DRAIN);
	...
	final var spell7 = new Spell(spell7Effect, 17, BattleTarget.ENEMY, Sounds.EFFECT_DARKNESS);
